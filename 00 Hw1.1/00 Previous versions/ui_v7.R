  ...
  dashboardBody( 
    ...
    tabItems(
      tabItem(tabName = "Q1a",
              ...
              div(HTML("1.- Boxplot and density plot of City Mileage vs transmision. <br>
                       The analysis is done with a new variable that differs between automatic and manual cars. <br>
                       The objective is to determine whether the mean between both populations is equal <br>")),
              fluidPage(
                ...
                div(HTML("2.- In order to test if there is a difference between the means, we propose to use One-Way ANOVA. <br>
                         Before we test the assumptions of normality of the errors and Hocedasticity with Jarque bera and Levene tests.<br>
                         Finally we use ANOVA and Kruskall-Wallis tests. <br>
                         There is also an option of performing the whole process removing the outliers from the City Mileage Data. <br>
                         We can Conclude by using the log of the data that there is a difference <br> ")),
      ...
      tabItem(tabName = "Q1b",
              ...
              div(HTML("1.- Boxplot and density plot of Highway Mileage vs transmision. <br>
                       The analysis is done with a new variable that differs between automatic and manual cars. <br>
                       The objective is to determine whether the mean between both populations is equal <br>")),
              fluidPage(
      ...
      tabItem(tabName = "Q1c",
              ...
              div(HTML("1.- Boxplot and density plot of Engine displacement vs transmision. <br>
                       The analysis is done with a new variable that differs between automatic and manual cars. <br>
                       The objective is to determine whether the mean between both populations is equal <br>")),
      ...
      tabItem(tabName = "Q3",
              ...
              h5("One the histogram plot we compare the distribution of the number of cylinders each automotive has throught the years "),
              h5("One the scatterplot it is illustrated how the milage is affected by the type of transmission and the year of the car manufacturing."),
...
#### PLOTS #####  
  ...
  output$year3 <- renderPlot({
    ...
    ggplot(data = dataset(),aes(x=hwy,y=cty, fill = year, color=year)) +
             geom_point() +
             labs(x="Type of transmission",y="NUmber of Miles") + 
             ggtitle("Mileage") + 
             theme(plot.title = element_text(size = 40, face = "bold", hjust = 0.5)) + theme_minimal()
