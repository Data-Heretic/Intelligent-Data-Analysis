...
hw2.2_q2_ui <- function(id, options) {
    ...
    tabPanel(title = "Question 2",
        column(10,
            ...
            fluidRow(
                box(width = 6,
                    h5("Let's estimate the odds ratio of crossing vs. retreat without taking into account the control variable."),
                ...
                box(width = 6,
                    h5("The odds ratio is greater than 1 for low traffic which means that the odds of crossing for cars are higher than the odds for trucks."),
